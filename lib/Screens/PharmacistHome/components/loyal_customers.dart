...
class LoyalCustomers extends StatefulWidget {
  const LoyalCustomers({Key? key}) : super(key: key);

  @override
  _LoyalCustomersState createState() => _LoyalCustomersState();
}

class _LoyalCustomersState extends State<LoyalCustomers> {
  ...
  void initState() {
    ...
    String uid = user?.uid ?? "";
    super.initState();
    databaseReference.child('pharmacies').child(uid).child('loyal_customers').onValue.listen((event) {
      setState(() {
        _isLoading = false;
        usersList = [];
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Search by customers name',
