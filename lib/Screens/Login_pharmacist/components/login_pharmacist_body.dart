...
import 'package:skeleton_prototype/Screens/PharmacistHome/pharmacist_home_screen.dart';
                ...
                child: RoundedButton(
                    ...
                    press: () async {
                      ...
                      if (user != null) {
                        ...
                        final DatabaseReference usersRef = database.child('pharmacies');

                        usersRef.once().then((DataSnapshot snapshot){
                          print(snapshot.value.keys);
                          snapshot.value.keys.forEach((e) {
                            if (e == user!.uid) {
