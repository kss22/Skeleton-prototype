...
import 'package:skeleton_prototype/users.dart';

import '../../doctors.dart';

class DoctorBodySignup extends StatefulWidget {
  const DoctorBodySignup({Key? key}) : super(key: key);

  @override
  _DoctorBodySignupState createState() => _DoctorBodySignupState();
}

class _DoctorBodySignupState extends State<DoctorBodySignup> {
  ...
  Widget build(BuildContext context) {
    ...
    DatabaseReference user1Ref = database.child('doctors');
